...
<%--<%@taglib prefix="vaccination" uri="/WEB-INF/tlds/Emma" %>--%>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              ...
              <div class="card-body">
                  <form method="post" action="AdminLogin" class="text-start">
                  ...
                  <div class="alert alert-danger">
                      <p>Cannot find email: <%out.print(data);%> and                  
                        <%out.print(pas);%></p>
                  </div>
                    <% }%>   
                  ...
                  <p class="mt-4 text-sm text-center">
                    ...
                    <a href="./sign-up.jsp" class="text-primary text-gradient font-weight-bold">Sign up</a>
                      ...
                      <%--<vaccination:insert table="kkdk" values="hdj"/>--%>
  <!--   Core JS Files   -->
