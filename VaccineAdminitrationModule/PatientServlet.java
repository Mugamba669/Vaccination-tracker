...
//                    String val = request.getParameter("name");
              ...
              request.setAttribute("status",status);
                      ...
                      request.getRequestDispatcher("./pages/patients.jsp").include(request, response);
                      request.getRequestDispatcher("Certificate").forward(request, response);
             
     
//out.println("<script type='text/javascript'>window.location = './pages/patients.jsp'</script>");
            out.println("</body>");
            out.println("</html>");
        }
    }
