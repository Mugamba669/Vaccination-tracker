 ...
 */
public class Distribution extends SimpleTagSupport {
...
String[] arr = values.split(",");
       ...
       if(arr.length > 1){
          state.execute("update "+ table +" set totalVaccine='"+arr[0]+"' where id='"+arr[1]+"'");
 ...
 out.print("<script type='text/javascript'>window.location = './pages/dashboard.jsp';</script>");
            ...
            throw new JspException("Error in Distribution tag", ex);
        }
    }
